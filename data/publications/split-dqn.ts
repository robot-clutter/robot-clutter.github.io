...
const SPLIT_DQN_PUB = {
  ...
  journal_small: 'ICRA',
  authors: [AUTHORS.IASON_SARANTOPOULOS, AUTHORS.MARIOS_KIATOS, AUTHORS.ZOE_DOULGERI, AUTHORS.SOTIRIS_MALASSIOTIS],
  abstract:
  ...
  videos: ['https://www.youtube.com/watch?v=ef1MKgVkN0E'],
  code: [
    {
